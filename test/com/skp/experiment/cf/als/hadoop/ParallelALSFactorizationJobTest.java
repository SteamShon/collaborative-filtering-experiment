...
import com.skp.experiment.common.MathHelper;
...
public class ParallelALSFactorizationJobTest extends MahoutTestCase {
  ...
  public void setUp() throws Exception {
    ...
    indexSizeFile = getTestTempFile("index.size");
  ...
  public void completeJobToyExample() throws Exception {
    ...
    alsFactorization.run(new String[] { 
        "--input", inputFile.getAbsolutePath(), "--output", outputDir.getAbsolutePath(),
