...
package com.skp.experiment.fpm.pfpgrowth;
...
public final class PFPGrowth {
  ...
  public static List<Pair<String,TopKStringPatterns>> readFrequentPattern(Parameters params) throws IOException {
    ...
    for (FileStatus fileStatus : outputFiles) {
      ret.addAll(org.apache.mahout.fpm.pfpgrowth.fpgrowth.FPGrowth.readFrequentPattern(conf, fileStatus.getPath()));
    }
    return ret;
  }
  ...
  public static void runPFPGrowth(Parameters params) throws IOException,
    ...
    runPFPGrowth(new Configuration(), params);
  }
  /**
   * 
   * @param params
   ...
   *          include minSupport(3), maxHeapSize(50), numGroups(1000)
   */
  public static void runPFPGrowth(Configuration conf, Parameters params) throws IOException,
                                                    InterruptedException,
                                                    ClassNotFoundException {
